        ...
        <div class="container mx-auto flex items-center justify-between">
            <div class="flex items-center space-x-4">
                ...
                <form class="relative" @submit.prevent="handleSearch">
                    <Input v-model="searchQuery" type="text" placeholder="Search games..." class="dark" />
                    <Button type="submit" variant="ghost" class="absolute right-0 top-0 h-full px-3 dark">
            ...
            <div class="flex items-center space-x-4">
                <NavigationMenu class="dark">
                    <NavigationMenuList>
                        ...
                        <NavigationMenuItem v-if="!authStore.loggedIn" class="ml-8">
                            <NuxtLink to="/login">
                        ...
                        <NavigationMenuItem v-if="authStore.loggedIn" class="ml-8">
                            <NuxtLink to="/profile">
                                <Button variant="link" class="dark">My Profile</Button>
                            </NuxtLink>
                        </NavigationMenuItem>
                    </NavigationMenuList>
                </NavigationMenu>
