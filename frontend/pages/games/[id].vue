<template>
    <div class="flex flex-col items-center">
            ...
            <div class="container mx-auto p-8">
                <div v-if="game" class="flex flex-col md:flex-row gap-8">
                    <div class="md:w-1/3 justify-center">
                        <NuxtImg :src="game.cover_art" :alt="game.name + ' cover'" width="300" height="400"
                        ...
                        <div v-if="game.platforms" class="mb-4">
                            ...
                            <ul class="flex flex-wrap gap-2">
                                <li v-for="platform in platforms" :key="platform.id"
                                    ...
                                    <Icon :name="game.platforms.includes(platform.id) ? platform.icon : ''
                                        " size="24" />
                                </li>
                            </ul>
                        </div>
        ...
        <div class="container mx-auto p-8">
            ...
            <ReportButton class="mb-4" :game="gameID" @submit="
                refreshNuxtData([
                    `reports-${gameID.value}`,
                    `featureStats-${gameID.value}`,
                    `score-${gameID.value}`,
                ])
                " />
